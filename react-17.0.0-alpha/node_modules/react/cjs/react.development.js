  ...
  (function () {
    ...
    var ReactElement = function (type, key, ref, self, source, owner, props) {
      var element = {
        ...
        // isValidElement 就是通过 $$typeof 来判断的
     ...
     * @param {*} type 结点的 tag， "div" 或 App 或 React.fragment
     * @param {*} config 一大堆属性组成的对象, { title: .., ref: .., key: .., ... }
     * @param {*} children 第一个子结点，剩余的都在 arguments 里躺着呢
     */
    function createElement(type, config, children) {
      ...
      // App.defaultProps 合并到 props 大对象里
